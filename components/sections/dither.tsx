...
/** biome-ignore-all lint/style/useConsistentMemberAccessibility: Designer Elements need no linting */
/** biome-ignore-all lint/performance/noNamespaceImport: Designer Elements need no linting */
/** biome-ignore-all lint/style/noNonNullAssertion: Designer Elements need no linting */
/** biome-ignore-all lint/suspicious/noExplicitAny: Designer Elements need no linting */
/** biome-ignore-all lint/style/useConsistentTypeDefinitions: Designer Elements need no linting */
